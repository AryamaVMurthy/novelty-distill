#!/usr/bin/env python3
"""Run one bounded baseline through the pinned official DistiLLM entrypoint."""
...
from novelty_distill.training.distillm import (
    execute_distillm_training,
    load_distillm_run_spec,
)
...
def main() -> None:
    ...
    metadata = execute_distillm_training(
        load_distillm_run_spec(args.config),
