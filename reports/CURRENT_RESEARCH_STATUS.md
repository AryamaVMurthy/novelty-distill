...
Last authoritative snapshot: 2026-08-04. The compact K=4 baseline study is
complete; no cluster jobs remain.
...
KL (`D1`) does not improve over `C1-best1`.
...
baseline, `C2-best1` as the mode-seeking control, and `D1` as the on-policy
